...
echo "#	Build: case = WRFPLUS, MPI" >> test_000m.csh
...
echo "docker exec test_000m ./da_builds.csh WRFPlus" >> test_000m.csh
...
echo "	docker exec test_000m cat WRFPLUS/foo" >> test_000m.csh
